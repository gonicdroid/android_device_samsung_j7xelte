...
public class DisplayModeControl {
    ...
    private static final DisplayMode[] DISPLAY_MODES = {
        new DisplayMode(0, "Adaptable"),
        new DisplayMode(1, "AMOLED Cinema"),
        new DisplayMode(2, "AMOLED Photo"),
        new DisplayMode(4, "sRGB"),
    };
    ...
    public static boolean isSupported() {
        return FileUtils.isFileWritable(MODE_PATH) && FileUtils.isFileReadable(MODE_PATH);
    }
    ...
    public static DisplayMode getCurrentMode() {
        try {
            int currentId = Integer.parseInt(FileUtils.readOneLine(MODE_PATH));
